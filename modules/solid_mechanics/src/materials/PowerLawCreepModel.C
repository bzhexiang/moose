...
Real
PowerLawCreepModel::computeResidual(const unsigned int /*qp*/, const Real effectiveTrialStress, const Real scalar, Real & reference_residual)
{
  Real creep_rate = _coefficient * std::pow(effectiveTrialStress - 3.0 * _shear_modulus * scalar, _n_exponent)
